        ...
        <div class="row">
            <div class="col-12">
                <div class="sectionHead">
                    <span class="secName"><%=section.getSname()%></span>
                    <span class="postNo">主帖数：<%=section.getPosts()%></span>
                    <a class="postNo"
                       href="user?uid=<%=section.getUser().getUid()%>">版主：<%=section.getUser().getUname()%>
                    </a>
                    <a href="posting?sid=<%=section.getSid()%>" class="btn btn-outline-info">我要发贴</a>
                </div>
                <%
